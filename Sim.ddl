...
DROP TABLE SIM_pp CASCADE CONSTRAINTS ;
...
ALTER TABLE SIM_pp ADD CONSTRAINT SIM_pp_PK PRIMARY KEY ( pp_id ) ;
...
ALTER TABLE SIM_pp ADD CONSTRAINT SIM_pp_SIM_Person_FK FOREIGN KEY ( SIM_Person_person_id ) REFERENCES SIM_Person ( person_id ) ;

ALTER TABLE SIM_pp ADD CONSTRAINT SIM_pp_SIM_project_FK FOREIGN KEY ( SIM_project_project_id ) REFERENCES SIM_project ( project_id ) ;
